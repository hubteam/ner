...
import com.wxw.ner.loader.DictionaryWrapper;
import com.wxw.ner.loader.ReadAdditionalDitionary;
 ...
 *
 */
public class NERMsrContextGeneratorConf implements NERMsrContextGenerator{
  ...
  //增加的字典特征的控制变量
	 ...
	 * @throws IOException
	 */
	public NERMsrContextGeneratorConf() throws IOException{
	...
	public NERMsrContextGeneratorConf(Properties properties){
...
//	    System.out.println(lengthNS);
	...
	private void init(Properties config) {
        ...
        PuSet = (config.getProperty("msr.Pu", "true").equals("true"));
        
        TSet = (config.getProperty("msr.T", "true").equals("true"));
...
//		}
	...
	public String toString() {
		...
		return "NERMsrContextGeneratorConf{" + "w_2Set=" + w_2Set + ", w_1Set=" + w_1Set + 
                ", w0Set=" + w0Set + ", w1Set=" + w1Set + ", w2Set=" + w2Set + 
                ", w_2w_1Set=" + w_2w_1Set + ", w_1w0Set=" + w_1w0Set + 
                ", w0w1Set=" + w0w1Set + ", c1c2Set=" + w1w2Set + 
                ", w_1w1Set=" + w_1w1Set + ", PuSet=" + PuSet + 
